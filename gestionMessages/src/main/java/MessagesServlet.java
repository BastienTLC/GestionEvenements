...
public class MessagesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ((operation!=null)&&(operation.equals("listeMessageMongoDB"))) {
		...
		if (idMembre!=null) {
			request.setAttribute("messages", this.getMessagesMongoByMembreId(Integer.parseInt(idMembre)));
			// forwarde la requï¿½te ï¿½ la page JSP
			getServletConfig().getServletContext().getRequestDispatcher("/afficheMessagesMongoDB.jsp")
				.forward(request, response);
		}
		...
		if (idEvent!=null) {
			request.setAttribute("messages", this.getMessagesMongoByEventId(Integer.parseInt(idEvent)));
			// forwarde la requï¿½te ï¿½ la page JSP
			getServletConfig().getServletContext().getRequestDispatcher("/afficheMessagesMongoDB.jsp")
				.forward(request, response);
		}
